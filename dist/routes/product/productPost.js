...
router.post('/create', authenticateTokenAdmin_1.default, async (req, res) => {
    ...
    try {
        ...
        const capitalizedProductName = (0, capitalizeName_1.default)(PRODUCT_NAME.toLowerCase());
        //VERIFICA SE JÁ EXISTE ALGUM PRODUTO COM O NOME PASSADO NO 'PRODUCT_NAME'
        const productNameNotUnique = await schemaProduct_1.default.findOne({ PRODUCT_NAME: capitalizedProductName });
        ...
        //EXECUTA O POST
        const newProduct = await schemaProduct_1.default.create({ PRODUCT_NAME: capitalizedProductName, PRODUCT_CATEGORY, PRODUCT_QUANTITY, PRODUCT_PRICE });
        //RETORNA O RESULTADO
